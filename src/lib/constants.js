export const BRAND = {
  name: 'Eqahku',
  tagline: 'Merayakan Amanah dengan Penuh Ketulusan',
  description:
    'Layanan aqiqah premium yang menghadirkan kualitas terbaik, proses syar\'i yang transparan, dan pengalaman personal untuk momen sakral keluarga Anda.',
  whatsapp: '6281234567890',
  email: 'halo@eqahku.id',
  instagram: '@eqahku.id',
...
export const PACKAGES = [
  {
    ...
    features: [
      ...
      'Masakan olahan 80 porsi nasi box',
      'Dokumentasi proses pemotongan',
  ...
  },
  {
    ...
    features: [
      ...
      'Pemotongan sesuai syar\'i dengan sertifikat',
      'Masakan olahan premium 120 porsi nasi box',
      'Menu pilihan: Gulai, Sate, Tongseng, dll',
      'Nasi kotak eksklusif dengan kemasan premium',
      'Video dokumentasi proses lengkap',
  ...
  },
  {
    ...
    features: [
      ...
      'Masakan olahan premium 200 porsi',
      'Pilihan menu lengkap tanpa batas',
      'Kemasan premium eksklusif',
      'Video cinematic dokumentasi',
      'Sertifikat aqiqah bermaterai',
      'Kartu ucapan custom premium',
      'Konsultasi personal dengan tim',
      'Pengiriman prioritas se-Jawa',
    ],
    popular: false,
  },
]
